...
public class YoutubeMusicPlayActivity extends YouTubeBaseActivity
    ...
    private YoutubeMusicPlayActivity context;
...
//        adView.loadAd(adRequest);
        ...
        dao.getPlayList(version, new OnResponseListener() {
            @Override
            public void onResponse(Response response) {

                try {

                    playList = (MusicArrayList) response.get("playList");
                    ...
                    PropertyManager pm = new PropertyManager(context);

                    ytpv.initialize(pm.getAPIKey("YouTubeAPIKey"), context);
